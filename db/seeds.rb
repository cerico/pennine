...
t1.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'hike2.jpg')))
 t2.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'kieldersnow.jpg')))
 ...
 t3.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'ullswater.jpg')))
 t4.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'bowland.jpg')))
 t5.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'todmorden.jpg')))
 t5.photos.create(image: File.open(File.join(Rails.root.join('public'), 'todmorden2.jpg')))
 t6.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'kettlewell.jpg')))
 t7.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'westsomerton.jpg')))
 t8.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'littlerissington.jpg')))
 t9.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'scafellpike.jpg')))
 t9.photos.create(image: File.open(File.join(Rails.root.join('public'), 'scafellpike2.jpg')))
 t10.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'hike7.jpg')))
 t11.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'delamere3.jpg')))
  t12.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'shropshirehills.jpg')))
  t13.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'llyndinas.jpg')))
  t14.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'wirral.jpg')))
  t15.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'oldmanofhoy.jpg')))
 t15.photos.create(image: File.open(File.join(Rails.root.join('public'), 'italianchapel.jpg')))
 t16.photos.create(name:"main", image: File.open(File.join(Rails.root.join('public'), 'shutlingsloemain.jpg')))
