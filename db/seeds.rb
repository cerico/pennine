...
t1 = Trail.create!(name:"Tarn Hows",county:"Cumbria",description:"x",lat:55.1833,lng:-2.5000,rating:8,distance:11.2,user_id:1)
  t2 = Trail.create!(name:"Kielder Forest",county:"Northumberland",description:"x",lat:55.1833,lng:-2.5000,postcode:"CA16 6QP",rating:9,distance:17.7,user_id:1)
 ...
 t4 = Trail.create!(name:"Forest of Bowland",county:"Lancashire",description:"x",lat:55.1833,lng:-2.5000,rating:8,distance:8.7,user_id:1)
...
t12 = Trail.create!(name:"Shropshire Hills",county:"Shrophsire",description:"here",lat:2.222,lng:-2.222,postcode:"here",rating:8,distance:9.4,user_id:1)
